    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" data-widget="control-sidebar" data-controlsidebar-slide="true" href="#" role="button">
         <i class="fa fa-money"></i>Saldo: <span id="saldoMostrado"></span>
        </a>
      </li>
      <li class="nav-item">
    ...
    ?></a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="pages/forms/vendedor.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="pages/forms/cuentas.php" class="nav-link">
              <i class="fa fa-plus-circle"></i>
              <p>
               Agregar Cuentas
              </p>
          ...
          <li class="nav-item">
            <a href="pages/forms/cuentaslistado.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="pages/forms/reglaspreciosyproductos.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="pages/forms/vendedorlistado.php" class="nav-link">
              <i class="fa fa-tasks"></i>
              <p>
          ...
          <li class="nav-item">
            <a href="pages/forms/cerrarsesion.php" class="nav-link">
