  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Manejo General de Vendedores</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Manejo General de Vendedores</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    $grupoSql = "SELECT * FROM usuarios";
    $grupoResult = $conn->query($grupoSql);
    if ($grupoResult->num_rows > 0) {
        while ($grupoRow = $grupoResult->fetch_assoc()) {
            echo '<tr>';
            echo '<td>' . $grupoRow["nombre"] . '</td>';
            echo '<td>' . $grupoRow["apellido"] . '</td>';
            echo '<td>' . $grupoRow["usuario"]  . '</td>';
            echo '<td>' . $grupoRow["tipousuario"] . '</td>';
            echo '<td>' . $grupoRow["tipovendedor"] . '</td>';
