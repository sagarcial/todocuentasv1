  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Manejo General de Cuentas</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Manejo General de Cuentas</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
// Obtiene la fecha y hora actual en Bogotá
$fecha_actual_bogota = date('Y-m-d');
    // Obtener registros de la tabla grupos
    $grupoSql = "SELECT * FROM vista_cuentas_servicios";
...
$timestamp1 = strtotime($grupoRow["fechavence"]);
$timestamp2 = strtotime($fecha_actual_bogota);
...
$diferenciaDias = $diferenciaSegundos / (60 * 60 * 24); // Diferencia en días
            ...
            echo '<tr>';
            echo '<td>' . $grupoRow["cuenta"] . '</td>';
            echo '<td>' . $grupoRow["contrasena"] . '</td>';
            echo '<td>' . $grupoRow["plataforma"] .'  '. trim(str_replace('_', ' ', $grupoRow["Tiposerv"])) .  '</td>';
            echo '<td>' . $grupoRow["pantalla"] . '</td>';
            echo '<td>' . $grupoRow["pin"] . '</td>';
            echo '<td>' . $grupoRow["estado"] . '</td>';
            echo '<td>' . $grupoRow["nombre"] .'  '. $grupoRow["apellido"] . '</td>';
            echo '<td>' . $grupoRow["fecha"] . '</td>';
            echo '<td>' . $grupoRow["fechavence"] . '</td>';
