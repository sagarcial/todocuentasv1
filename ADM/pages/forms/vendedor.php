          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Crear Cuenta Vendedor</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="../../../php/crearvendedor.php" method="post">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="apellido" class="form-control" id="apellidos" placeholder="Ingrese los apellidos">
                    </div>
                    <div class="form-group">
...
?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="saldo" class="form-control" id="saldo" placeholder="Ingrese el saldo">
                    </div>
